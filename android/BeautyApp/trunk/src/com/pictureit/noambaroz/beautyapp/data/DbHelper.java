...
public class DbHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("create table ordersnotification (_id integer primary key autoincrement, notificationid text, beauticianid text, name text, address text, raters integer, rate integer, at text, location text, remarks text, price text);");
