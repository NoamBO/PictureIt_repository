...
import net.simonvt.numberpicker.R.attr;
import net.simonvt.numberpicker.R.id;
import net.simonvt.numberpicker.R.layout;
import net.simonvt.numberpicker.R.string;
import net.simonvt.numberpicker.R.styleable;
...
public class TimePicker extends FrameLayout {
    ...
    private void setContentDescriptions() {
        // Minute
        String text = getContext().getString(R.string.time_picker_increment_minute_button);
        mMinuteSpinner.setIncrementButtonContentDescription(text);
        text = getContext().getString(R.string.time_picker_decrement_minute_button);
        mMinuteSpinner.setDecrementButtonContentDescription(text);
        // Hour
        text = getContext().getString(R.string.time_picker_increment_hour_button);
        mHourSpinner.setIncrementButtonContentDescription(text);
        text = getContext().getString(R.string.time_picker_decrement_hour_button);
        mHourSpinner.setDecrementButtonContentDescription(text);
        // AM/PM
        if (mAmPmSpinner != null) {
            text = getContext().getString(R.string.time_picker_increment_set_pm_button);
            mAmPmSpinner.setIncrementButtonContentDescription(text);
            text = getContext().getString(R.string.time_picker_decrement_set_am_button);
            mAmPmSpinner.setDecrementButtonContentDescription(text);
        }
    }
