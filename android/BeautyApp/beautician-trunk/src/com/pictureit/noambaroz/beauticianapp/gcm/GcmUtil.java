...
import com.pictureit.noambaroz.beauticianapp.server.BaseHttpPost;
import com.pictureit.noambaroz.beauticianapp.server.JsonToObject;
import com.pictureit.noambaroz.beauticianapp.server.ServerUtil;
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				try {
					...
					if (!regid.equalsIgnoreCase(getRegistrationId()))
